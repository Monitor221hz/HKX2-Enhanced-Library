...
namespace HKX2E
{
    ...
    public partial class hkpCharacterMotion : hkpMotion, IEquatable<hkpCharacterMotion?>
    {
        ...
        {
            return Equals(obj as hkpCharacterMotion);
        }

        public bool Equals(hkpCharacterMotion? other)
        {
