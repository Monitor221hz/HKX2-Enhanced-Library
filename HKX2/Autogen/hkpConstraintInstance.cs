...
namespace HKX2E
{
    ...
    public partial class hkpConstraintInstance
        : hkReferencedObject,
            IEquatable<hkpConstraintInstance?>
    {
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            constraintModifiers = xd.ReadClassPointer<hkpModifierConstraintAtom>(
                this,
                xe,
                nameof(constraintModifiers)
            );
            ...
            destructionRemapInfo = xd.ReadFlag<OnDestructionRemapInfo, byte>(
                xe,
                nameof(destructionRemapInfo)
            );
        ...
        public override void WriteXml(IHavokXmlWriter xs, XElement xe)
        {
            ...
            xs.WriteEnum<OnDestructionRemapInfo, byte>(
                xe,
                nameof(destructionRemapInfo),
        ...
        public bool Equals(hkpConstraintInstance? other)
        {
            return other is not null
                ...
                && (
                    (constraintModifiers is null && other.constraintModifiers is null)
                    || (
                        constraintModifiers is not null
                        && other.constraintModifiers is not null
                        && constraintModifiers.Equals((IHavokObject)other.constraintModifiers)
                    )
                )
