...
namespace HKX2E
{
    ...
    public partial class hkpLimitedHingeConstraintDataAtoms
        : IHavokObject,
            IEquatable<hkpLimitedHingeConstraintDataAtoms?>
    {
        ...
        public bool Equals(hkpLimitedHingeConstraintDataAtoms? other)
        {
            return other is not null
                ...
                && (
                    (angMotor is null && other.angMotor is null)
                    || (
                        angMotor is not null
                        && other.angMotor is not null
                        && angMotor.Equals((IHavokObject)other.angMotor)
                    )
                )
                && (
