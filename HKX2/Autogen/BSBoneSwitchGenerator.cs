...
namespace HKX2E
{
    ...
    public partial class BSBoneSwitchGenerator : hkbGenerator, IEquatable<BSBoneSwitchGenerator?>
    {
        ...
        public IList<BSBoneSwitchGeneratorBoneData> ChildrenA { set; get; } =
            Array.Empty<BSBoneSwitchGeneratorBoneData>();
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            ChildrenA = xd.ReadClassPointerArray<BSBoneSwitchGeneratorBoneData>(
                this,
                xe,
                nameof(ChildrenA)
            );
