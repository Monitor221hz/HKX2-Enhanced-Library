...
namespace HKX2E
{
    ...
    public partial class hkpCogWheelConstraintDataAtoms
        : IHavokObject,
            IEquatable<hkpCogWheelConstraintDataAtoms?>
    {
        ...
        public bool Equals(hkpCogWheelConstraintDataAtoms? other)
        {
            return other is not null
                ...
                && (
                    (cogWheels is null && other.cogWheels is null)
                    || (
                        cogWheels is not null
                        && other.cogWheels is not null
                        && cogWheels.Equals((IHavokObject)other.cogWheels)
                    )
                )
