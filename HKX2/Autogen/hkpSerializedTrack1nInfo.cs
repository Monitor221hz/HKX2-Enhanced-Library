...
namespace HKX2E
{
    ...
    public partial class hkpSerializedTrack1nInfo
        : IHavokObject,
            IEquatable<hkpSerializedTrack1nInfo?>
    {
        public IList<hkpAgent1nSector> sectors { set; get; } = Array.Empty<hkpAgent1nSector>();
        public IList<hkpSerializedSubTrack1nInfo> subTracks { set; get; } =
            Array.Empty<hkpSerializedSubTrack1nInfo>();
        ...
        public virtual void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            subTracks = xd.ReadClassPointerArray<hkpSerializedSubTrack1nInfo>(
                this,
                xe,
                nameof(subTracks)
            );
