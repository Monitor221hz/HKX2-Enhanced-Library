...
namespace HKX2E
{
    ...
    public partial class hkbSetBehaviorCommand
        : hkReferencedObject,
            IEquatable<hkbSetBehaviorCommand?>
    {
        public ulong characterId { set; get; }
        public hkbBehaviorGraph? behavior { set; get; }
        public hkbGenerator? rootGenerator { set; get; }
        public IList<hkbBehaviorGraph> referencedBehaviors { set; get; } =
            Array.Empty<hkbBehaviorGraph>();
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            referencedBehaviors = xd.ReadClassPointerArray<hkbBehaviorGraph>(
                this,
                xe,
                nameof(referencedBehaviors)
            );
        ...
        public bool Equals(hkbSetBehaviorCommand? other)
        {
            return other is not null
                ...
                && (
                    (behavior is null && other.behavior is null)
                    || (
                        behavior is not null
                        && other.behavior is not null
                        && behavior.Equals((IHavokObject)other.behavior)
                    )
                )
                && (
                    (rootGenerator is null && other.rootGenerator is null)
                    || (
                        rootGenerator is not null
                        && other.rootGenerator is not null
                        && rootGenerator.Equals((IHavokObject)other.rootGenerator)
                    )
                )
