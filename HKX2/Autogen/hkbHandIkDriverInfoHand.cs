...
namespace HKX2
{
    ...
    public partial class hkbHandIkDriverInfoHand : IHavokObject, IEquatable<hkbHandIkDriverInfoHand?>
    {
        ...
        {
            return Equals(obj as hkbHandIkDriverInfoHand);
        }

        public bool Equals(hkbHandIkDriverInfoHand? other)
        {
