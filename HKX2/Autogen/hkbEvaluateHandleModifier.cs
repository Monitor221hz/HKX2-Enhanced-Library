...
namespace HKX2E
{
    ...
    public partial class hkbEvaluateHandleModifier
        : hkbModifier,
            IEquatable<hkbEvaluateHandleModifier?>
    {
        ...
        public bool Equals(hkbEvaluateHandleModifier? other)
        {
            return other is not null
                && base.Equals(other)
                && (
                    (handle is null && other.handle is null)
                    || (
                        handle is not null
                        && other.handle is not null
                        && handle.Equals((IHavokObject)other.handle)
                    )
                )
