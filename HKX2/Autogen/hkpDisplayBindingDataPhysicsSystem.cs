...
namespace HKX2E
{
    ...
    public partial class hkpDisplayBindingDataPhysicsSystem
        : hkReferencedObject,
            IEquatable<hkpDisplayBindingDataPhysicsSystem?>
    {
        public IList<hkpDisplayBindingDataRigidBody> bindings { set; get; } =
        ...
        {
            base.ReadXml(xd, xe);
            bindings = xd.ReadClassPointerArray<hkpDisplayBindingDataRigidBody>(
                this,
                xe,
                nameof(bindings)
            );
        ...
        public bool Equals(hkpDisplayBindingDataPhysicsSystem? other)
        {
            return other is not null
                ...
                && (
                    (system is null && other.system is null)
                    || (
                        system is not null
                        && other.system is not null
                        && system.Equals((IHavokObject)other.system)
                    )
                )
