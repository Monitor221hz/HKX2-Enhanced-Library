...
namespace HKX2E
{
    ...
    public partial class hkpCylinderShape : hkpConvexShape, IEquatable<hkpCylinderShape?>
    {
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            cylBaseRadiusFactorForHeightFieldCollisions = xd.ReadSingle(
                xe,
                nameof(cylBaseRadiusFactorForHeightFieldCollisions)
            );
        ...
        public bool Equals(hkpCylinderShape? other)
        {
            return other is not null
                ...
                && cylBaseRadiusFactorForHeightFieldCollisions.Equals(
                    other.cylBaseRadiusFactorForHeightFieldCollisions
                )
