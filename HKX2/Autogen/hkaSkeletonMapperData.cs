...
namespace HKX2E
{
    ...
    public partial class hkaSkeletonMapperData : IHavokObject, IEquatable<hkaSkeletonMapperData?>
    {
        ...
        public IList<hkaSkeletonMapperDataSimpleMapping> simpleMappings { set; get; } =
            Array.Empty<hkaSkeletonMapperDataSimpleMapping>();
        public IList<hkaSkeletonMapperDataChainMapping> chainMappings { set; get; } =
            Array.Empty<hkaSkeletonMapperDataChainMapping>();
        ...
        public virtual void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            simpleMappings = xd.ReadClassArray<hkaSkeletonMapperDataSimpleMapping>(
                xe,
                nameof(simpleMappings)
            );
            chainMappings = xd.ReadClassArray<hkaSkeletonMapperDataChainMapping>(
                xe,
                nameof(chainMappings)
            );
        ...
        public bool Equals(hkaSkeletonMapperData? other)
        {
            return other is not null
                && (
                    (skeletonA is null && other.skeletonA is null)
                    || (
                        skeletonA is not null
                        && other.skeletonA is not null
                        && skeletonA.Equals((IHavokObject)other.skeletonA)
                    )
                )
                && (
                    (skeletonB is null && other.skeletonB is null)
                    || (
                        skeletonB is not null
                        && other.skeletonB is not null
                        && skeletonB.Equals((IHavokObject)other.skeletonB)
                    )
                )
