...
namespace HKX2E
{
    ...
    {
        public static hkbStateMachine GetDefault() =>
            new()
            {
                startStateId = 0,
        ...
        public IList<hkbStateMachineStateInfo> states { set; get; } =
            Array.Empty<hkbStateMachineStateInfo>();
        ...
        {
            base.ReadXml(xd, xe);
            eventToSendWhenStateOrTransitionChanges = xd.ReadClass<hkbEvent>(
                xe,
                nameof(eventToSendWhenStateOrTransitionChanges)
            );
            startStateChooser = xd.ReadClassPointer<hkbStateChooser>(
                this,
                xe,
                nameof(startStateChooser)
            );
            ...
            transitionToNextHigherStateEventId = xd.ReadInt32(
                xe,
                nameof(transitionToNextHigherStateEventId)
            );
            transitionToNextLowerStateEventId = xd.ReadInt32(
                xe,
                nameof(transitionToNextLowerStateEventId)
            );
            ...
            selfTransitionMode = xd.ReadFlag<StateMachineSelfTransitionMode, sbyte>(
                xe,
                nameof(selfTransitionMode)
            );
            states = xd.ReadClassPointerArray<hkbStateMachineStateInfo>(this, xe, nameof(states));
            wildcardTransitions = xd.ReadClassPointer<hkbStateMachineTransitionInfoArray>(
                this,
                xe,
                nameof(wildcardTransitions)
            );
        }
        ...
        public override void WriteXml(IHavokXmlWriter xs, XElement xe)
        {
            ...
            xs.WriteEnum<StateMachineSelfTransitionMode, sbyte>(
                xe,
                nameof(selfTransitionMode),
                selfTransitionMode
            );
        ...
        public bool Equals(hkbStateMachine? other)
        {
            return other is not null
                ...
                && (
                    (
                        eventToSendWhenStateOrTransitionChanges is null
                        && other.eventToSendWhenStateOrTransitionChanges is null
                    )
                    || (
                        eventToSendWhenStateOrTransitionChanges is not null
                        && other.eventToSendWhenStateOrTransitionChanges is not null
                        && eventToSendWhenStateOrTransitionChanges.Equals(
                            (IHavokObject)other.eventToSendWhenStateOrTransitionChanges
                        )
                    )
                )
                && (
                    (startStateChooser is null && other.startStateChooser is null)
                    || (
                        startStateChooser is not null
                        && other.startStateChooser is not null
                        && startStateChooser.Equals((IHavokObject)other.startStateChooser)
                    )
                )
                ...
                && transitionToNextHigherStateEventId.Equals(
                    other.transitionToNextHigherStateEventId
                )
                ...
                && (
                    (wildcardTransitions is null && other.wildcardTransitions is null)
                    || (
                        wildcardTransitions is not null
                        && other.wildcardTransitions is not null
                        && wildcardTransitions.Equals((IHavokObject)other.wildcardTransitions)
                    )
                )
