...
namespace HKX2E
{
    ...
    {
        public hkbCharacterDataCharacterControllerInfo characterControllerInfo { set; get; } =
            new();
        ...
        {
            base.ReadXml(xd, xe);
            characterControllerInfo = xd.ReadClass<hkbCharacterDataCharacterControllerInfo>(
                xe,
                nameof(characterControllerInfo)
            );
            ...
            characterPropertyValues = xd.ReadClassPointer<hkbVariableValueSet>(
                this,
                xe,
                nameof(characterPropertyValues)
            );
            footIkDriverInfo = xd.ReadClassPointer<hkbFootIkDriverInfo>(
                this,
                xe,
                nameof(footIkDriverInfo)
            );
            handIkDriverInfo = xd.ReadClassPointer<hkbHandIkDriverInfo>(
                this,
                xe,
                nameof(handIkDriverInfo)
            );
            stringData = xd.ReadClassPointer<hkbCharacterStringData>(this, xe, nameof(stringData));
            mirroredSkeletonInfo = xd.ReadClassPointer<hkbMirroredSkeletonInfo>(
                this,
                xe,
                nameof(mirroredSkeletonInfo)
            );
        ...
        {
            base.WriteXml(xs, xe);
            xs.WriteClass<hkbCharacterDataCharacterControllerInfo>(
                xe,
                nameof(characterControllerInfo),
        ...
        public bool Equals(hkbCharacterData? other)
        {
            return other is not null
                && base.Equals(other)
                && (
                    (characterControllerInfo is null && other.characterControllerInfo is null)
                    || (
                        characterControllerInfo is not null
                        && other.characterControllerInfo is not null
                        && characterControllerInfo.Equals(
                            (IHavokObject)other.characterControllerInfo
                        )
                    )
                )
                ...
                && (
                    (characterPropertyValues is null && other.characterPropertyValues is null)
                    || (
                        characterPropertyValues is not null
                        && other.characterPropertyValues is not null
                        && characterPropertyValues.Equals(
                            (IHavokObject)other.characterPropertyValues
                        )
                    )
                )
                && (
                    (footIkDriverInfo is null && other.footIkDriverInfo is null)
                    || (
                        footIkDriverInfo is not null
                        && other.footIkDriverInfo is not null
                        && footIkDriverInfo.Equals((IHavokObject)other.footIkDriverInfo)
                    )
                )
                && (
                    (handIkDriverInfo is null && other.handIkDriverInfo is null)
                    || (
                        handIkDriverInfo is not null
                        && other.handIkDriverInfo is not null
                        && handIkDriverInfo.Equals((IHavokObject)other.handIkDriverInfo)
                    )
                )
                && (
                ...
                && (
                    (mirroredSkeletonInfo is null && other.mirroredSkeletonInfo is null)
                    || (
                        mirroredSkeletonInfo is not null
                        && other.mirroredSkeletonInfo is not null
                        && mirroredSkeletonInfo.Equals((IHavokObject)other.mirroredSkeletonInfo)
                    )
                )
