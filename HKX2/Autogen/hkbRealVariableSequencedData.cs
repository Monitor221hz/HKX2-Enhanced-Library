...
namespace HKX2E
{
    ...
    public partial class hkbRealVariableSequencedData
        : hkbSequencedData,
            IEquatable<hkbRealVariableSequencedData?>
    {
        public IList<hkbRealVariableSequencedDataSample> samples { set; get; } =
            Array.Empty<hkbRealVariableSequencedDataSample>();
