...
namespace HKX2E
{
    ...
    public partial class hkpCharacterProxyCinfo
        : hkpCharacterControllerCinfo,
            IEquatable<hkpCharacterProxyCinfo?>
    {
        ...
        public bool Equals(hkpCharacterProxyCinfo? other)
        {
            return other is not null
                ...
                && (
                    (shapePhantom is null && other.shapePhantom is null)
                    || (
                        shapePhantom is not null
                        && other.shapePhantom is not null
                        && shapePhantom.Equals((IHavokObject)other.shapePhantom)
                    )
                )
