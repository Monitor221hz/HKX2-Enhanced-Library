...
namespace HKX2
{
    ...
    // @eventQueue class: hkpTriggerVolume@eventInfo Type.TYPE_ARRAY Type.TYPE_STRUCT arrSize: 0 offset: 56 flags: FLAGS_NONE enum: 
    ...
    public partial class hkpTriggerVolume : hkReferencedObject, IEquatable<hkpTriggerVolume?>
    {
        ...
        public IList<hkpTriggerVolume@eventInfo> @eventQueue { set; get; } = Array.Empty<hkpTriggerVolume@eventInfo>();
        ...
        public override void Read(PackFileDeserializer des, BinaryReaderEx br)
        {
            ...
            @eventQueue = des.ReadClassArray<hkpTriggerVolume@eventInfo>(br);
        ...
        public override void ReadXml(IXmlReader xd, XElement xe)
        {
            ...
            @eventQueue = xd.ReadClassArray<hkpTriggerVolume@eventInfo>(xe, nameof(@eventQueue));
