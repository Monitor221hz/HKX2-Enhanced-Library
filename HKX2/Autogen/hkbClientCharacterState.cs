...
namespace HKX2E
{
    ...
    public partial class hkbClientCharacterState : hkReferencedObject, IEquatable<hkbClientCharacterState?>
    {
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            behaviorData = xd.ReadClassPointer<hkbBehaviorGraphData>(xe, nameof(behaviorData));
            behaviorInternalState = xd.ReadClassPointer<hkbBehaviorGraphInternalState>(xe, nameof(behaviorInternalState));
