...
namespace HKX2E
{
    ...
    public partial class hkpSimpleContactConstraintAtom
        : hkpConstraintAtom,
            IEquatable<hkpSimpleContactConstraintAtom?>
    {
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            contactPointPropertiesStriding = xd.ReadByte(
                xe,
                nameof(contactPointPropertiesStriding)
            );
