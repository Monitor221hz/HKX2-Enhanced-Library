...
namespace HKX2E
{
    ...
    public partial class hkbBoolVariableSequencedData
        : hkbSequencedData,
            IEquatable<hkbBoolVariableSequencedData?>
    {
        public IList<hkbBoolVariableSequencedDataSample> samples { set; get; } =
            Array.Empty<hkbBoolVariableSequencedDataSample>();
