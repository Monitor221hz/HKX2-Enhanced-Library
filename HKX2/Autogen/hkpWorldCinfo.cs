...
namespace HKX2E
{
    ...
    public partial class hkpWorldCinfo : hkReferencedObject, IEquatable<hkpWorldCinfo?>
    {
        ...
        public override void ReadXml(IHavokXmlReader xd, XElement xe)
        {
            ...
            broadPhaseBorderBehaviour = xd.ReadFlag<BroadPhaseBorderBehaviour, sbyte>(
                xe,
                nameof(broadPhaseBorderBehaviour)
            );
            mtPostponeAndSortBroadPhaseBorderCallbacks = xd.ReadBoolean(
                xe,
                nameof(mtPostponeAndSortBroadPhaseBorderCallbacks)
            );
            ...
            collisionFilter = xd.ReadClassPointer<hkpCollisionFilter>(
                this,
                xe,
                nameof(collisionFilter)
            );
            convexListFilter = xd.ReadClassPointer<hkpConvexListFilter>(
                this,
                xe,
                nameof(convexListFilter)
            );
            ...
            memoryWatchDog = xd.ReadClassPointer<hkWorldMemoryAvailableWatchDog>(
                this,
                xe,
                nameof(memoryWatchDog)
            );
            broadPhaseNumMarkers = xd.ReadInt32(xe, nameof(broadPhaseNumMarkers));
            contactPointGeneration = xd.ReadFlag<ContactPointGeneration, sbyte>(
                xe,
                nameof(contactPointGeneration)
            );
            allowToSkipConfirmedCallbacks = xd.ReadBoolean(
                xe,
                nameof(allowToSkipConfirmedCallbacks)
            );
            ...
            forceCoherentConstraintOrderingInSolver = xd.ReadBoolean(
                xe,
                nameof(forceCoherentConstraintOrderingInSolver)
            );
            ...
            iterativeLinearCastEarlyOutDistance = xd.ReadSingle(
                xe,
                nameof(iterativeLinearCastEarlyOutDistance)
            );
            iterativeLinearCastMaxIterations = xd.ReadInt32(
                xe,
                nameof(iterativeLinearCastMaxIterations)
            );
            deactivationNumInactiveFramesSelectFlag0 = xd.ReadByte(
                xe,
                nameof(deactivationNumInactiveFramesSelectFlag0)
            );
            deactivationNumInactiveFramesSelectFlag1 = xd.ReadByte(
                xe,
                nameof(deactivationNumInactiveFramesSelectFlag1)
            );
        ...
        public override void WriteXml(IHavokXmlWriter xs, XElement xe)
        {
            ...
            xs.WriteEnum<BroadPhaseBorderBehaviour, sbyte>(
                xe,
                nameof(broadPhaseBorderBehaviour),
            ...
            xs.WriteEnum<ContactPointGeneration, sbyte>(
                xe,
                nameof(contactPointGeneration),
        ...
        public bool Equals(hkpWorldCinfo? other)
        {
            return other is not null
                ...
                && mtPostponeAndSortBroadPhaseBorderCallbacks.Equals(
                    other.mtPostponeAndSortBroadPhaseBorderCallbacks
                )
                && (
                    (broadPhaseWorldAabb is null && other.broadPhaseWorldAabb is null)
                    || (
                        broadPhaseWorldAabb is not null
                        && other.broadPhaseWorldAabb is not null
                        && broadPhaseWorldAabb.Equals((IHavokObject)other.broadPhaseWorldAabb)
                    )
                )
                ...
                && (
                    (collisionFilter is null && other.collisionFilter is null)
                    || (
                        collisionFilter is not null
                        && other.collisionFilter is not null
                        && collisionFilter.Equals((IHavokObject)other.collisionFilter)
                    )
                )
                && (
                    (convexListFilter is null && other.convexListFilter is null)
                    || (
                        convexListFilter is not null
                        && other.convexListFilter is not null
                        && convexListFilter.Equals((IHavokObject)other.convexListFilter)
                    )
                )
                ...
                && (
                    (memoryWatchDog is null && other.memoryWatchDog is null)
                    || (
                        memoryWatchDog is not null
                        && other.memoryWatchDog is not null
                        && memoryWatchDog.Equals((IHavokObject)other.memoryWatchDog)
                    )
                )
                ...
                && forceCoherentConstraintOrderingInSolver.Equals(
                    other.forceCoherentConstraintOrderingInSolver
                )
                ...
                && iterativeLinearCastEarlyOutDistance.Equals(
                    other.iterativeLinearCastEarlyOutDistance
                )
                && iterativeLinearCastMaxIterations.Equals(other.iterativeLinearCastMaxIterations)
                && deactivationNumInactiveFramesSelectFlag0.Equals(
                    other.deactivationNumInactiveFramesSelectFlag0
                )
                && deactivationNumInactiveFramesSelectFlag1.Equals(
                    other.deactivationNumInactiveFramesSelectFlag1
                )
