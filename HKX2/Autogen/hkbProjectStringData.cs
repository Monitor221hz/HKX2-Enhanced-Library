...
namespace HKX2E
{
    ...
    public partial class hkbProjectStringData
        : hkReferencedObject,
            IEquatable<hkbProjectStringData?>
    {
        ...
        public bool Equals(hkbProjectStringData? other)
        {
            return other is not null
                ...
                && (
                    animationPath is null && other.animationPath is null
                    || animationPath == other.animationPath
                    || animationPath is null && other.animationPath == ""
                    || animationPath == "" && other.animationPath is null
                )
                && (
                    behaviorPath is null && other.behaviorPath is null
                    || behaviorPath == other.behaviorPath
                    || behaviorPath is null && other.behaviorPath == ""
                    || behaviorPath == "" && other.behaviorPath is null
                )
                && (
                    characterPath is null && other.characterPath is null
                    || characterPath == other.characterPath
                    || characterPath is null && other.characterPath == ""
                    || characterPath == "" && other.characterPath is null
                )
                && (
                    fullPathToSource is null && other.fullPathToSource is null
                    || fullPathToSource == other.fullPathToSource
                    || fullPathToSource is null && other.fullPathToSource == ""
                    || fullPathToSource == "" && other.fullPathToSource is null
                )
