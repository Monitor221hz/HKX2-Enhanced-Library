...
namespace HKX2E
{
    ...
    public partial class hkbStateMachineTransitionInfo
        : IHavokObject,
            IEquatable<hkbStateMachineTransitionInfo?>
    {
        public static hkbStateMachineTransitionInfo GetDefault() =>
            new()
            {
        ...
        {
            triggerInterval = xd.ReadClass<hkbStateMachineTimeInterval>(
                xe,
                nameof(triggerInterval)
            );
            initiateInterval = xd.ReadClass<hkbStateMachineTimeInterval>(
                xe,
                nameof(initiateInterval)
            );
        ...
        {
            xs.WriteClass<hkbStateMachineTimeInterval>(
                xe,
                nameof(triggerInterval),
                triggerInterval
            );
        ...
        public bool Equals(hkbStateMachineTransitionInfo? other)
        {
            return other is not null
                && (
                    (triggerInterval is null && other.triggerInterval is null)
                    || (
                        triggerInterval is not null
                        && other.triggerInterval is not null
                        && triggerInterval.Equals((IHavokObject)other.triggerInterval)
                    )
                )
                && (
                    (initiateInterval is null && other.initiateInterval is null)
                    || (
                        initiateInterval is not null
                        && other.initiateInterval is not null
                        && initiateInterval.Equals((IHavokObject)other.initiateInterval)
                    )
                )
                && (
                    (transition is null && other.transition is null)
                    || (
                        transition is not null
                        && other.transition is not null
                        && transition.Equals((IHavokObject)other.transition)
                    )
                )
                && (
                    (condition is null && other.condition is null)
                    || (
                        condition is not null
                        && other.condition is not null
                        && condition.Equals((IHavokObject)other.condition)
                    )
                )
