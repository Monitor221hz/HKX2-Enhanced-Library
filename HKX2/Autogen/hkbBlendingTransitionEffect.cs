...
namespace HKX2E
{
    ...
    public partial class hkbBlendingTransitionEffect
        : hkbTransitionEffect,
            IEquatable<hkbBlendingTransitionEffect?>
    {
        public static hkbBlendingTransitionEffect GetDefault() =>
            new()
            {
        ...
        public IList<object> characterPoseAtBeginningOfTransition { set; get; } =
            Array.Empty<object>();
