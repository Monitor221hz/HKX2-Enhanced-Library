...
namespace HKX2E
{
    ...
    public partial class hkaAnnotationTrack : IHavokObject, IEquatable<hkaAnnotationTrack?>
    {
        ...
        public IList<hkaAnnotationTrackAnnotation> annotations { set; get; } =
            Array.Empty<hkaAnnotationTrackAnnotation>();
        ...
        public bool Equals(hkaAnnotationTrack? other)
        {
            return other is not null
                && (
                    trackName is null && other.trackName is null
                    || trackName == other.trackName
                    || trackName is null && other.trackName == ""
                    || trackName == "" && other.trackName is null
                )
