...
namespace HKX2E.Utils
{
    ...
    {
        public static Dictionary<(System.Type, System.Type), System.Type> ClassCache { get; set; } =
            new();
        ...
        public static System.Type CreateDummyType(System.Type targetType, System.Type dummyType)
        {
            ...
            FieldBuilder fbIsDummy = tb.DefineField(
                "IsDummy",
                typeof(bool),
                FieldAttributes.Public
            );
            FieldBuilder fbValue = tb.DefineField(
                "ConflictValue",
                typeof(IHavokObject),
                FieldAttributes.Public
            );
            ...
            var mReadHkxBody = tb.DefineMethod(
                mReadHkxInfo!.Name,
                MethodAttributes.Public
                    | MethodAttributes.Virtual
                    | MethodAttributes.ReuseSlot
                    | MethodAttributes.HideBySig,
                mReadHkxInfo.ReturnType,
                mReadHkxInfo.GetParameters().Select(t => t.ParameterType).ToArray()
            );
            ...
            var mWriteHkxBody = tb.DefineMethod(
                mWriteHkxInfo!.Name,
                MethodAttributes.Public
                    | MethodAttributes.Virtual
                    | MethodAttributes.ReuseSlot
                    | MethodAttributes.HideBySig,
                mWriteHkxInfo.ReturnType,
                mWriteHkxInfo.GetParameters().Select(t => t.ParameterType).ToArray()
            );
            ...
            var mReadXmlBody = tb.DefineMethod(
                mReadXmlInfo!.Name,
                MethodAttributes.Public
                    | MethodAttributes.Virtual
                    | MethodAttributes.ReuseSlot
                    | MethodAttributes.HideBySig,
                mReadXmlInfo.ReturnType,
                mReadXmlInfo.GetParameters().Select(t => t.ParameterType).ToArray()
            );
            ...
            var mWriteXmlBody = tb.DefineMethod(
                mWriteXmlInfo!.Name,
                MethodAttributes.Public
                    | MethodAttributes.Virtual
                    | MethodAttributes.ReuseSlot
                    | MethodAttributes.HideBySig,
                mWriteXmlInfo.ReturnType,
                mWriteXmlInfo.GetParameters().Select(t => t.ParameterType).ToArray()
            );
        ...
        public static dynamic CreateDummy<T>(T targetObject, System.Type dummyType)
