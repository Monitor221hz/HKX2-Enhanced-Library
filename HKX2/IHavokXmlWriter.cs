...
public interface IHavokXmlWriter
{
    ...
    void WriteClass<T>(XElement xe, string paramName, T value)
        where T : IHavokObject;
    void WriteClassArray<T>(XElement xe, string paramName, IList<T> values)
        where T : IHavokObject;
    void WriteClassPointer<T>(XElement xe, string paramName, T? value)
        where T : IHavokObject;
    void WriteClassPointerArray<T>(XElement xe, string paramName, IList<T?> values)
        where T : IHavokObject;
    ...
    XElement WriteFlag<TEnum, TValue>(XElement xe, string paramName, TValue value)
        where TEnum : Enum
        where TValue : IBinaryInteger<TValue>;
    XElement WriteFloat<T>(XElement xe, string paramName, T value)
        where T : IFloatingPoint<T>;
    XElement WriteFloatArray<T>(XElement xe, string paramName, IList<T> value)
        where T : IFloatingPoint<T>;
    ...
    XElement WriteNumber<T>(XElement xe, string paramName, T value)
        where T : IBinaryInteger<T>;
    XElement WriteNumberArray<T>(XElement xe, string paramName, IList<T> value)
        where T : IBinaryInteger<T>;
