...
public interface IHavokXmlReader
{
    ...
    T ReadClass<T>(XElement element, string name)
        where T : IHavokObject, new();
    IList<T> ReadClassArray<T>(XElement element, string name)
        where T : IHavokObject, new();
    T[] ReadClassCStyleArray<T>(XElement element, string name, short length)
        where T : IHavokObject, new();
    T? ReadClassPointer<T>(IHavokObject owner, XElement element, string name)
        where T : IHavokObject, new();
    IList<T> ReadClassPointerArray<T>(IHavokObject owner, XElement element, string name)
        where T : IHavokObject, new();
    T?[] ReadClassPointerCStyleArray<T>(
        IHavokObject owner,
        XElement element,
        string name,
        short length
